...
Three operating modes:
  - provider_configured (openai / azure_openai):  real LLM is available
...
AIMode = Literal["deterministic_fallback", "openai", "azure_openai", "provider_not_configured"]
...
def get_advisory_response(
    ...
    # --- mode is "openai" or "azure_openai" — real LLM call ---
