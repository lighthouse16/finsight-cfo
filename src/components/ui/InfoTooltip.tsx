  ...
  return (
    <span className="group relative inline-flex align-middle">
      <button
        type="button"
        aria-label={label}
        aria-describedby="market-watch-info-tooltip"
      ...
      <span
        id="market-watch-info-tooltip"
        role="tooltip"
        className="pointer-events-none absolute left-1/2 top-full z-50 mt-2 w-max max-w-[calc(100vw-2rem)] -translate-x-1/2 whitespace-nowrap rounded-full border border-white/70 bg-white/90 px-3.5 py-2 text-left text-xs font-medium leading-none text-softform-navy-900 opacity-0 shadow-floating-panel backdrop-blur-xl transition-all duration-200 group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:translate-y-0 group-focus-within:opacity-100 sm:left-0 sm:translate-x-0"
      >
        {content}
      </span>
    </span>
