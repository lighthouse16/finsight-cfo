...
import { FxPair, GbaFundingSignal } from '../types'
...
export default function FxGbaTab({ fxPairs, gbaSignals }: FxGbaTabProps) {
  return (
      ...
      <div className="space-y-6">
        ...
        <div className="softform-panel rounded-[28px] p-6 sm:p-8">
          ...
          <div className="flex flex-col gap-3">
            <div className="rounded-xl bg-white/40 border border-white/50 p-4 shadow-sm">
              ...
              <p className="text-xs text-softform-text-primary leading-relaxed">
                Raw material pricing remains tied to USD. Cross-currency stability helps hedge input volatility.
              </p>
            </div>
            <div className="rounded-xl bg-white/40 border border-white/50 p-4 shadow-sm">
              <span className="inline-block rounded-full bg-softform-navy-900/5 px-2.5 py-0.5 text-xs font-semibold text-softform-text-secondary mb-2">
              ...
              <p className="text-xs text-softform-text-primary leading-relaxed">
                CNY translation margins are sensitive to offshore conversion windows.
              </p>
            </div>
            <div className="rounded-xl bg-white/40 border border-white/50 p-4 shadow-sm">
              <span className="inline-block rounded-full bg-softform-navy-900/5 px-2.5 py-0.5 text-xs font-semibold text-softform-text-secondary mb-2">
              ...
              <p className="text-xs text-softform-text-primary leading-relaxed">
                Onshore treasury structures show favorable rate spreads, subject to capital control limits.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-6">
        <div className="softform-card rounded-[28px] p-6 sm:p-8">
          ...
          <div className="mt-6 rounded-xl bg-softform-navy-900/5 p-4 text-xs font-medium leading-relaxed text-softform-text-muted">
            <strong className="block text-softform-navy-900 mb-1">Important Watch Signal:</strong>
            This is a contextual indicator. Do not initiate RMB borrowing without consulting your treasury policy.
          </div>
        </div>
